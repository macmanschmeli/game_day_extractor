...
public class CloudflareHTMLExtractor {
    ...
    String getHTML(String endpoint){
        try (Playwright playwright = Playwright.create()) {
            ...
            String url = "https://panel.volleystation.com/website/150/de/phase-4089-no1llh/schedule/";
    ...
    public static void simulateHumanActivity(Page page) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            try { Thread.sleep(random.nextInt(500) + 200); } catch (Exception ignored) {}
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            try { Thread.sleep(random.nextInt(800) + 400); } catch (Exception ignored) {}
        }
    }
}
